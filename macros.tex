...
\newcommand{\mD}[0]{\mathfrak D}%deprecated
...
\newcommand{\cf}[2]{\left\lceil\frac{#1}{#2}\right\rceil}
...
\newcommand{\bkk}[1]{\langle{#1}|{#1}\rangle}
\newcommand{\bok}[3]{\langle{#1}|{#2}|{#3}\rangle}
...
\newcommand{\vvt}[1]{{#1}{#1}^\top}
\newcommand{\pvvt}[1]{\pa{#1}\pa{#1}^\top}
\newcommand{\vtv}[1]{{#1}^\top{#1}}
\newcommand{\pvtv}[1]{\pa{#1}^\top\pa{#1}}
...
\newcommand{\KL}[0]{\operatorname{KL}}
\newcommand{\TV}[0]{\mathrm{TV}}
